...
import { LineChart, ArrowLeft, Activity, Info, Plus, TrendingUp, ArrowDown, LineChart as LineChartIcon } from 'lucide-react'
    ...
    const loadData = async () => {
        try {
            ...
            const formattedHistory = (historyData || []).map((h: any) => ({
                date: new Date(h.recordedAt).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' }),
                        ...
                        <GlassCard className="p-6">
                            ...
                            <div className="relative h-4 mt-1">
                                <div
                                    ...
                                    style={{ left: `${Math.min(Math.max((bmiNum / 40) * 100, 0), 100)}%` }}
                                >
