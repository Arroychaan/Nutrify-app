...
import { Check, X, Loader2, Leaf } from 'lucide-react'
...
function VerifyContent() {
    ...
    return (
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 text-center">
            {/* Logo */}
